      ...
      <div className="flex flex-1 flex-col justify-center">
        <main className="flex flex-1 flex-col items-center justify-center gap-14">
          <div className="relative">
            <h1 className="relative z-[2] bg-gradient-to-r from-amber-500 to-red-500 bg-clip-text text-center text-4xl font-bold text-transparent after:absolute after:right-[-30px] after:top-[-25px] after:z-[-1] after:rotate-[20deg] after:content-['🦇'] md:text-6xl">
              Just a boilerplate
            </h1>
